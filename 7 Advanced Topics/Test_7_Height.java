...
public class Test_7_Height extends Base
{
    ...
    public void initialize()
    {
        ...
        HeightGeometry heightGeo = new HeightGeometry(
            "images/heightmap-128.png", -10, 10, 0, 1, -10, 10 ); 
        ...
        Material material = new LambertMaterial( new Texture("images/sand.jpg") );
        
        Mesh terrain = new Mesh(heightGeo, material);
